...
public class OrderController {
    ...
    @PostMapping
    public Result<MallOrder> create(@RequestBody CreateOrderDTO dto) {
    ...
    public Result<MallOrder> detailByNo(@PathVariable String orderNo) {
        return Result.success(orderService.detailByOrderNo(orderNo));
    }
